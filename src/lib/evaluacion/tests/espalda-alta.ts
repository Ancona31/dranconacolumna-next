...
export const espaldaAltaTest: TestDefinition = {
  ...
  triage: [
    {
      ...
      options: [
        { label: "Sí", action: "flag:banda-dorsal" },
    ...
    },
    {
      ...
      options: [
        { label: "Sí", action: "flag:urgente-neurologico-dorsal" },
        { label: "No", action: "flag:deficit-dorsal" },
      ],
    },
    {
      id: "T3",
