...
export default function MobileActionBar() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 flex border-t border-ink/10 md:hidden">
      <Link
        href="/evaluacion"
        className="flex-1 bg-primary py-4 text-center font-body text-sm font-semibold text-white"
      >
        Hacer mi evaluación
      </Link>
      <a
        ...
        className="flex-1 bg-whatsapp py-4 text-center font-body text-sm font-semibold text-white"
      >
        WhatsApp
      </a>
    </div>
